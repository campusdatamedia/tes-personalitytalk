    ...
    <div class="container">
        <ul class="nav navbar-nav">
            <li class="nav-item" style="{{ is_int(strpos(Request::path(), 'dashboard')) ? 'visibility:hidden' : 'visibility:visible' }}">
                <a class="nav-link text-white fw-bold" href="/"><i class="fa fa-arrow-left"></i> Kembali</a>
            </li>
        </ul>
        ...
        <ul class="nav navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white fw-bold" id="btn-logout" href="#">Keluar <i class="fa fa-sign-out"></i></a>
