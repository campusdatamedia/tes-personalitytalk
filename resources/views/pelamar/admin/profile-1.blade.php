...
<script type="text/javascript">
  ...
  //   var ask = confirm("Anda yakin ingin mentidakloloskan pelamar ini dari tes administrasi?");
  //   if(ask){
  //     $.ajax({
  //       type: "post",
  //       url: "/admin/tahap-administrasi/is-not-pass",
  //       data: {_token: "{{ csrf_token() }}", id_pelamar: id_pelamar, id_lowongan: id_lowongan},
  //       success: function(response){
  //         if(response == "Seleksi berhasil!"){
  //           alert(response);
  //           window.location.href = '/admin/tahap-administrasi';
  //         }
  //       }
  //     });
  //   }
